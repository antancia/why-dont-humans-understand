...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! /Users/Harmony/Code/why-dont-humans-understand/src/main.js */298);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GameOver = __webpack_require__(/*! ./states/GameOver */ 313);

	var _GameOver2 = _interopRequireDefault(_GameOver);

	var _config = __webpack_require__(/*! ./config */ 314);
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function preload() {
	      ...
	      this.load.atlas('cat', 'assets/images/cat-sprite-sheet.png', 'assets/atlases/cat-sprite-sheet.json');
	      this.load.atlas('objects', 'assets/images/objects-sprite-sheet.png', 'assets/atlases/objects-sprite-sheet.json');
...
/***/ function(module, exports) {
	...
	var createSprites = exports.createSprites = function createSprites(arrayOfSprites, addFunction, objectAddFunction) {
	  arrayOfSprites.forEach(function (sprite) {
	    addFunction(sprite);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Cat = __webpack_require__(/*! ../sprites/Cat */ 310);

	var _Cat2 = _interopRequireDefault(_Cat);

	var _BreakableObject = __webpack_require__(/*! ../sprites/BreakableObject */ 311);

	var _BreakableObject2 = _interopRequireDefault(_BreakableObject);

	var _Platform = __webpack_require__(/*! ../sprites/Platform */ 312);
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    key: 'updateScore',
	    value: function updateScore(action) {
	      switch (action) {
	        case 'meow':
	    ...
	    key: 'createAllSpritesOrPlatforms',
	    value: function createAllSpritesOrPlatforms(arrayOfSpritesOrPlatforms, type) {
	      var _this2 = this;

	      arrayOfSpritesOrPlatforms.forEach(function (thing) {
	        _this2.game.add.existing(thing);

	        if (type === 'sprite') {
	          _this2.objects.add(thing);
	        } else if (type === 'platform') {
	          _this2.platforms.add(thing);
	        }
	      });
	    }
	  }, {
	    ...
	    value: function create() {
	      ...
	      this.keyInput.xKey = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.X);
	      this.keyInput.zKey = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.Z);
	      this.keyInput.cKey = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.C);
	      this.keyInput.eKey = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.E);
	      ...
	      this.vase = new _BreakableObject2.default({
	        game: this.game,
	        x: 500,
	        y: 240,
	        asset: 'objects',
	      ...
	      this.cactus = new _BreakableObject2.default({
	        game: this.game,
	        x: 650,
	        y: 318,
	        asset: 'objects',
	      ...
	      this.clock = new _BreakableObject2.default({
	        game: this.game,
	        x: 170,
	        y: 145,
	        asset: 'objects',
	      ...
	      this.globe = new _BreakableObject2.default({
	        game: this.game,
	        x: 225,
	        y: 145,
	        asset: 'objects',
	      ...
	      this.lamp = new _BreakableObject2.default({
	        game: this.game,
	        x: 530,
	        y: 395,
	        asset: 'objects',
	      ...
	      this.glass1 = new _BreakableObject2.default({
	        game: this.game,
	        x: 480,
	        y: 410,
	        asset: 'objects',
	      ...
	      this.glass2 = new _BreakableObject2.default({
	        game: this.game,
	        x: 780,
	        y: 335,
	        asset: 'objects',
	      ...
	      this.glass3 = new _BreakableObject2.default({
	        game: this.game,
	        x: 910,
	        y: 335,
	        asset: 'objects',
	      ...
	      this.smallPlatform1 = new _Platform2.default({
	        game: this.game,
	        x: 650,
	        y: 350,
	      ...
	      this.smallPlatform2 = new _Platform2.default({
	        game: this.game,
	        x: 780,
	        y: 350,
	        asset: 'platform-small-pink'
	      ...
	      this.smallPlatform3 = new _Platform2.default({
	        game: this.game,
	        x: 910,
	        y: 350,
	        asset: 'platform-small-pink'
	      ...
	      this.smallPlatform4 = new _Platform2.default({
	        game: this.game,
	        x: 370,
	        y: 170,
	        asset: 'platform-small-pink'
	      ...
	      this.smallPlatform5 = new _Platform2.default({
	        game: this.game,
	        x: 220,
	        y: 170,
	        asset: 'platform-small-pink'
	      ...
	      this.smallPlatform6 = new _Platform2.default({
	        game: this.game,
	        x: 170,
	        y: 170,
	        asset: 'platform-small-pink'
	      ...
	      this.largePlatform1 = new _Platform2.default({
	        game: this.game,
	      ...
	      this.largePlatform2 = new _Platform2.default({
	        game: this.game,
	        x: this.world.centerX,
	        y: 260,
	        asset: 'platform-large-blue'
	      ...
	      this.gameSprites = [this.vase, this.cactus, this.clock, this.globe, this.lamp, this.glass1, this.glass2, this.glass3];
	      this.gamePlatforms = [this.largePlatform1, this.largePlatform2, this.smallPlatform1, this.smallPlatform2, this.smallPlatform3, this.smallPlatform4, this.smallPlatform5, this.smallPlatform6];
	    ...
	    value: function update() {
	      ...
	      this.keyInput.zKey.onDown.addOnce(function () {
	        _this3.updateScore(_this3.meowAction);
	      });

	      // Check if objects are hitting the ground
	      this.objects.forEach(function (object) {
	        if (object.body.onFloor()) {
	          _this3.explodeSound.play();
	          object.animations.play('explode');
	          object.events.onAnimationComplete.add(function () {
	            object.destroy();
	            _this3.updateScore(_this3.destroyAction);
	          });
	        }
	      });
	      ...
	      } else if (this.cat.body.onFloor() || this.cat.body.touching.down && _phaser2.default.Point.equals(this.cat.body.velocity, new _phaser2.default.Point(0, 0))) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(_ref) {
	    ...
	    // Add the animations
	    _this.animations.add('sit', ['cat-sit.png'], 5, true);
	    _this.animations.add('walk', _phaser2.default.Animation.generateFrameNames('cat-walk-', 1, 2, '.png'), 5, false);
	    _this.animations.add('jump', ['cat-jump-1.png', 'cat-jump-2.png'], 5, false);
	    _this.animations.add('sleep', ['cat-sleep-1.png', 'cat-sleep-2.png', 'cat-sleep-3.png', 'cat-sleep-2.png'], 3, true);
	    _this.animations.add('meow', ['cat-meow-1.png', 'cat-meow-2.png', 'cat-meow-1.png'], 3, false);
	    _this.animations.add('attack', ['cat-attack-1.png', 'cat-attack-2.png'], 4, false);
	    _this.animations.add('scratch', ['cat-scratch-1.png', 'cat-scratch-2.png'], 4, false);
	    _this.animations.add('eat', ['cat-eat-1.png', 'cat-sit.png'], 4, false);
	    return _this;
	  }

	  _createClass(_class, [{
	    key: 'walkDirection',
	    value: function walkDirection(direction) {
	      if (direction === 'right') {
	        this.scale.x = 4;
...
/* 311 */
/*!****************************************!*\
  !*** ./src/sprites/BreakableObject.js ***!
  \****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(_ref) {
	    ...
	    _this.animations.add('explode', _phaser2.default.Animation.generateFrameNames('explode-', 1, 3, '.png'), 20, false);
	    return _this;
	  }
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      ...
	      this.game.gameOverTextDisplay = this.game.add.bitmapText(20, this.game.height / 2 - 50, 'coders-crux', this.game.gameOverText, 40);
